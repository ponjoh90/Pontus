...
public class Input {
	...
	public static void update() {
		...
		// Kolla vilka knappar som är nedtryckta sen innan
		downKeys.clear();
		...
		// Kolla vilka knappar som är nedtryckta, antingen första gången eller
		// sen innan
		currentKeys.clear();
		...
		// Som för tangentbordet fast för mus.
		upMouse.clear();
